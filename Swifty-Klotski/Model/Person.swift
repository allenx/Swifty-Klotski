...
class Person {
    ...
    init(width: Int, height: Int, coordinate: (x: Int, y: Int), name: String, id: Int) {
        self.width = width
        self.height = height
    ...
    static let CaoCao = Person(width: 2, height: 2, coordinate: (1, 0), name: "曹操", id: 1)
    static let GuanYu = Person(width: 2, height: 1, coordinate: (1, 2), name: "关羽", id: 4)
    static let ZhaoYun = Person(width: 1, height: 2, coordinate: (0, 0), name: "赵云", id: 0)
    static let ZhangFei = Person(width: 1, height: 2, coordinate: (3, 2), name: "张飞", id: 7)
    static let MaChao = Person(width: 1, height: 2, coordinate: (0, 2), name: "马超", id: 3)
    static let HuangZhong = Person(width: 1, height: 2, coordinate: (3, 0), name: "黄忠", id: 2)
    static let Soldier1 = Person(width: 1, height: 1, coordinate: (0, 4), name: "士兵1", id: 5)
    static let Soldier2 = Person(width: 1, height: 1, coordinate: (1, 3), name: "士兵2", id: 6)
    static let Soldier3 = Person(width: 1, height: 1, coordinate: (2, 3), name: "士兵3", id: 8)
    static let Soldier4 = Person(width: 1, height: 1, coordinate: (3, 4), name: "士兵4", id: 9)
