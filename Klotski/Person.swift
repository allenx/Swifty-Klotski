...
//    static let CaoCao = Person(width: 2, height: 2, coordinate: (2, 1), name: "曹操")
//    static let GuanYu = Person(width: 2, height: 1, coordinate: (3, 3), name: "关羽")
//    static let ZhaoYun = Person(width: 2, height: 1, coordinate: (3, 4), name: "赵云")
//    static let ZhangFei = Person(width: 2, height: 1, coordinate: (2, 5), name: "张飞")
//    static let MaChao = Person(width: 1, height: 2, coordinate: (1, 3), name: "马超")
//    static let HuangZhong = Person(width: 1, height: 2, coordinate: (2, 3), name: "黄忠")
...
//    static let Soldier4 = Person(width: 1, height: 1, coordinate: (4, 2), name: "士兵4")
